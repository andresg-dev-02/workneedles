...
\restrict wpSP9FAjPhr3gtOslNWcXxyhTms1c3ZF2APRa6AdUzi6Can9mTe9NqFONnIzCb5
...
5	2	Camisa Formal	Camisa de algodón	Algodón	55000.00	\N	t	2026-05-17 21:59:28.753828	2026-05-17 21:59:51.107119
\.
...
COPY public."ProductoTallas" (id, idproducto, idtalla, stock, fechacreacion, fechamodificacion) FROM stdin;
\.
...
SELECT pg_catalog.setval('public."Colores_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."ProductoColores_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."ProductoTallas_id_seq"', 1, false);
...
SELECT pg_catalog.setval('public."Tallas_id_seq"', 1, false);
...
\unrestrict wpSP9FAjPhr3gtOslNWcXxyhTms1c3ZF2APRa6AdUzi6Can9mTe9NqFONnIzCb5
