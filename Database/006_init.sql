...
\restrict HjUcHtWo3tTc0RHRwfbBfI75wGbVd3OlMUCUvedw8yhUzovYoJ1begyk3X2tcoo
...
CREATE TABLE public."Colores" (
    ...
    codigohex character varying(7) NOT NULL,
...
ALTER SEQUENCE public."Colores_id_seq" OWNER TO postgres;
...
--
-- Name: ProductoColores; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ProductoColores" (
    id integer NOT NULL,
    idproducto integer,
    idcolor integer,
    fechacreacion timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
ALTER TABLE public."ProductoColores" OWNER TO postgres;

--
-- Name: ProductoColores_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."ProductoColores_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."ProductoColores_id_seq" OWNER TO postgres;

--
-- Name: ProductoColores_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."ProductoColores_id_seq" OWNED BY public."ProductoColores".id;


--
-- Name: ProductoTallas; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."ProductoTallas" (
    id integer NOT NULL,
    idproducto integer,
    idtalla integer,
    fechacreacion timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
ALTER TABLE public."ProductoTallas" OWNER TO postgres;

--
-- Name: ProductoTallas_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."ProductoTallas_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public."ProductoTallas_id_seq" OWNER TO postgres;

--
-- Name: ProductoTallas_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."ProductoTallas_id_seq" OWNED BY public."ProductoTallas".id;
...
--
-- Name: ProductoColores id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoColores" ALTER COLUMN id SET DEFAULT nextval('public."ProductoColores_id_seq"'::regclass);


--
-- Name: ProductoTallas id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoTallas" ALTER COLUMN id SET DEFAULT nextval('public."ProductoTallas_id_seq"'::regclass);
...
1	Telas	Materiales de tela para confección	2026-05-20 14:56:26.84629
2	Hilos	Hilos para costura	2026-05-20 14:56:41.14554
3	Accesorios	Botones, cierres y cremalleras	2026-05-20 14:56:53.663417
\.
...
2	Camisas	Categoría de camisas y blusas por igual	2026-05-17 21:21:04.592229
\.
...
COPY public."Colores" (id, nombre, codigohex, fechacreacion, fechamodificacion) FROM stdin;
1	Verde salvia	#A3B18A	2026-05-19 22:22:28.169513	2026-05-19 22:22:28.174545
\.
...
COPY public."DetallePedidos" (id, idpedido, idproducto, cantidad, preciounitario, subtotal, idinventario) FROM stdin;
1	2	5	2	55000.00	110000.00	1
\.
...
COPY public."Devoluciones" (id, idpedido, idusuario, motivo, estado, fecha, idcliente) FROM stdin;
4	2	3	Producto defectuoso, talla incorrecta	rechazada	2026-05-20 23:54:41.71367	2
\.
...
1	2	3	pendiente	en preparacion	Se inició la preparación del pedido	2026-05-20 23:47:46.925883
\.
...
2	1	Tela de Algodón	Tela 100% algodón	metros	500.00	50.00	8000.00	Textiles Colombia	t	2026-05-20 15:00:39.856858	2026-05-20 15:00:39.856866
4	2	Hilo Negro	Hilo para costura color negro	rollos	200.00	20.00	3000.00	Hilos y Más	t	2026-05-20 15:01:01.975771	2026-05-20 15:01:01.975776
5	3	Botón Dorado	Botón metálico dorado	unidades	1000.00	100.00	500.00	Accesorios Moda	t	2026-05-20 15:01:26.087512	2026-05-20 15:01:26.087519
\.
...
COPY public."Inventario" (id, idproducto, idcolor, idtalla, stock, fechacreacion, fechamodificacion) FROM stdin;
1	5	1	1	20	2026-05-20 00:00:15.321759	2026-05-20 00:01:45.073249
\.
...
1	2	3	2026-05-20 23:46:45.174241	110000.00	efectivo	pendiente	REF-001	Pago en efectivo en oficina	2026-05-20 23:46:45.176957
\.
...
2	2	3	2026-05-20 22:00:21.854317	2026-06-15	2026-06-20	pendiente	Calle 45 # 23-10	Entregar en horario de oficina	55000.00	5000.00	50000.00	2026-05-20 22:00:21.854318	2026-05-20 22:00:21.85432
\.
...
COPY public."Producto" (id, idcategoria, nombre, descripcion, material, preciobase, urlimagen, activo, fechacreacion, fechamodificacion, genero) FROM stdin;
5	2	Camisa Formal	Camisa de algodón	\N	55000.00	https://res.cloudinary.com/dgcrpsesh/image/upload/v1779385950/cld-sample-5.jpg	t	2026-05-17 21:59:28.753828	2026-05-21 12:59:18.972897	\N
\.


--
-- Data for Name: ProductoColores; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ProductoColores" (id, idproducto, idcolor, fechacreacion, fechamodificacion) FROM stdin;
1	5	1	2026-05-19 22:33:54.067607	2026-05-19 22:33:54.068501
\.


--
-- Data for Name: ProductoTallas; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public."ProductoTallas" (id, idproducto, idtalla, fechacreacion, fechamodificacion) FROM stdin;
1	5	1	2026-05-19 22:59:45.564652	2026-05-19 22:59:45.569958
\.
...
COPY public."Tallas" (id, nombre, fechacreacion, fechamodificacion) FROM stdin;
1	Medium	2026-05-19 22:30:35.912579	2026-05-19 22:30:35.918022
\.
...
3	1	1	1	Andres Felipe	Gonzalez Pineda	andrew@gmail.com	$2a$11$pZAMTD4gXdkx.Z8Dt8UKn.1.zeBWm43b8GqO1mIVY.ceSZLCSS6f6	3001234577	t	2026-05-17 18:33:33.883194	2026-05-17 18:33:33.884514
\.
...
2	1	1	1	persona	cedula	1234567890	Carlos	Ramirez	\N	carlos@gmail.com	3001234567	Calle 45 # 23-10	Ropa formal	t	2026-05-20 21:57:26.248898	2026-05-20 21:57:26.248903
\.
...
SELECT pg_catalog.setval('public."CategoriaInsumo_id_seq"', 3, true);
...
SELECT pg_catalog.setval('public."CategoriaProducto_id_seq"', 2, true);
...
SELECT pg_catalog.setval('public."Colores_id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."DetallePedidos_id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."Devoluciones_id_seq"', 4, true);
...
SELECT pg_catalog.setval('public."HistorialPedidos_id_seq"', 1, true);
...
SELECT pg_catalog.setval('public."InsumosProducto_id_seq"', 4, true);
...
--
-- Name: ProductoColores_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."ProductoColores_id_seq"', 1, true);


--
-- Name: ProductoTallas_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."ProductoTallas_id_seq"', 1, true);
...
--
-- Name: Inventario Inventario_idproducto_idcolor_idtalla_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Inventario"
    ADD CONSTRAINT "Inventario_idproducto_idcolor_idtalla_key" UNIQUE (idproducto, idcolor, idtalla);
...
--
-- Name: ProductoColores ProductoColores_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoColores"
    ADD CONSTRAINT "ProductoColores_pkey" PRIMARY KEY (id);


--
-- Name: ProductoTallas ProductoTallas_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoTallas"
    ADD CONSTRAINT "ProductoTallas_pkey" PRIMARY KEY (id);
...
--
-- Name: DetallePedidos DetallePedidos_idinventario_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."DetallePedidos"
    ADD CONSTRAINT "DetallePedidos_idinventario_fkey" FOREIGN KEY (idinventario) REFERENCES public."Inventario"(id);


--
-- Name: Devoluciones Devoluciones_idcliente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Devoluciones"
    ADD CONSTRAINT "Devoluciones_idcliente_fkey" FOREIGN KEY (idcliente) REFERENCES public.clientes(id);


--
-- Name: Inventario Inventario_idcolor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Inventario"
    ADD CONSTRAINT "Inventario_idcolor_fkey" FOREIGN KEY (idcolor) REFERENCES public."Colores"(id);


--
-- Name: Inventario Inventario_idproducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Inventario"
    ADD CONSTRAINT "Inventario_idproducto_fkey" FOREIGN KEY (idproducto) REFERENCES public."Producto"(id);


--
-- Name: Inventario Inventario_idtalla_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Inventario"
    ADD CONSTRAINT "Inventario_idtalla_fkey" FOREIGN KEY (idtalla) REFERENCES public."Tallas"(id);


--
-- Name: ProductoColores ProductoColores_idcolor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoColores"
    ADD CONSTRAINT "ProductoColores_idcolor_fkey" FOREIGN KEY (idcolor) REFERENCES public."Colores"(id);


--
-- Name: ProductoColores ProductoColores_idproducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoColores"
    ADD CONSTRAINT "ProductoColores_idproducto_fkey" FOREIGN KEY (idproducto) REFERENCES public."Producto"(id);


--
-- Name: ProductoTallas ProductoTallas_idproducto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoTallas"
    ADD CONSTRAINT "ProductoTallas_idproducto_fkey" FOREIGN KEY (idproducto) REFERENCES public."Producto"(id);


--
-- Name: ProductoTallas ProductoTallas_idtalla_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductoTallas"
    ADD CONSTRAINT "ProductoTallas_idtalla_fkey" FOREIGN KEY (idtalla) REFERENCES public."Tallas"(id);
...
ALTER TABLE ONLY public."Pagos"
    ADD CONSTRAINT fk_pagos_pedido FOREIGN KEY (idpedido) REFERENCES public."Pedidos"(id);
...
\unrestrict HjUcHtWo3tTc0RHRwfbBfI75wGbVd3OlMUCUvedw8yhUzovYoJ1begyk3X2tcoo
